...
public class GameMenu extends JFrame {
    ...
    public GameMenu(String username) {
        ...
        JPanel gamePanel = new JPanel(new GridLayout(2, 1, 0, 20));
        gamePanel.setBackground(new Color(230, 240, 250));

        JButton btnCreate = createStyledButton("Tạo Phòng", new Color(34, 139, 34), 18);
        JButton btnJoin = createStyledButton("Tham Gia Phòng", new Color(0, 123, 255), 18);

        gamePanel.add(btnCreate);
        gamePanel.add(btnJoin);

        centerPanel.add(gamePanel);

        JButton btnViewHistory = createStyledButton("Xem Lịch Sử Đấu", new Color(255, 165, 0), 18);
...
class WaitingRoomFrame extends JFrame {
    public WaitingRoomFrame(String displayName, GameMenu parentFrame) {
        ...
        JButton btnConfirm = createStyledButton("Xác nhận", new Color(34, 139, 34), 14);
        JButton btnCancel = createStyledButton("Hủy", new Color(220, 20, 60), 14);
...
class HistoryFrame extends JFrame {
    public HistoryFrame(String username) {
        ...
        String[] columnNames = {"Người Thắng", "Người Thua", "Tỉ số", "Thời gian"};
        ...
        JButton btnClose = createStyledButton("Đóng", new Color(220, 20, 60), 14);
